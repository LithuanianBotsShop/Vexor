...
void setup() {
    ...
    // robot.reverseSensorSignal(true);   // Use inverted logic (recommended) when sensor use inverted logic signal
    // robot.sensorPullUp(true);          // Enable internal pull-ups when sensor use inverted logic signal
...
void loop() {
    ...
    bool fr45 = robot.readSensor(FR45);
    bool fr90 = robot.readSensor(FR90);
    ...
    Serial.print("FR45: "); Serial.println(fr45 ? "OBSTACLE" : "CLEAR");
    Serial.print("FR90: "); Serial.println(fr90 ? "OBSTACLE" : "CLEAR");
    ...
    delay(2000);  // Wait 0.5 seconds between readings
}